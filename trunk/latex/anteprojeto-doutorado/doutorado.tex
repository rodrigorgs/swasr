...
%A transferência de boas práticas entre
%desenvolvedores de um projeto é importante para equilibrar diferenças de
%desempenho entre eles \cite{szulanski1996}. Apesar disso, a transferência pode
%ser prejudicada por fatores como falta de motivação ou a falta de experiência.
...
%O quanto variam as práticas entre diferentes
