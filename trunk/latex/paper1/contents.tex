...
% TODO: consider merging with introduction
...
network}. Software networks can be studied by network theory.

%Define: Component. Component dependency network. Directed unweighted graph.
%Clustering based on dependencies.

Network theory researchers study general properties of many types of networks by
...
are also scale-free networks \cite{Myers2003,Valverde2003}. Because of this
fact, it is possible to take advantage of network theory tools and techniques
when studying the structure of software systems in general.
...
(e.g., biologic networks). % TODO: whooo, too fast here.
In this section we present such a metric, together
with an experiment that evaluates its usefulness by applying it to both software
and non-software networks. %Then we show a classification model 
