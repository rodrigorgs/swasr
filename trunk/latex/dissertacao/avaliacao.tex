...
Na seção anterior foi apresentada uma função que classifica redes em software-realistas ou não software-realistas. Nesta seção a função de classificação é validada segundo dois critérios. Primeiro, a função deve classificar
