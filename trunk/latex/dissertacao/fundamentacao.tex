...
No domínio do agrupamento de software, exemplos de entidades incluem, entre outros, arquivos fonte \cite{Mancoridis1998}, funções e variáveis em sistema procedimentais \cite{Anquetil1999} e classes em um sistema orientado a objetos \cite{Trifu2001}.
...
\begin{itemize}
	...
	\item conjunto das classes que possuem métodos chamados pela classe descrita.
