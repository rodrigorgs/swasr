...
\begin{section}{Introdução}
	...
	\begin{itemize}
		...
		% TODO: na Seção \ref{cap:clasmetric} é introduzida formalmente uma métrica de software-realismo
		
		\item na Seção \ref{cap:clas2} é descrito um classificador que induz modelos de classificação de redes; % TODO: usando a métrica de software-realismo.		
...
\begin{section}{Grau de Software-Realismo}
