\include{main_mestrado}

% GLOSSÁRIO:
% * Algoritmos de agrupamento de software (programas de computador)
% * Lei de potência
% * Grafo particionado? Rede com módulos embutidos? Rede estruturada em módulos? Rede hierárquica de dois níveis?
% * Gerar? Sintetizar? Sintéticas? Artificiais?
% * Rede de software
% * Redes sintéticas
% * Softwareness?
