...
\begin{section}{Software-realismo}
...
Vale notar que o coeficiente de correlação neste caso não possui significado estatístico, mas ele têm sido usado de forma bem sucedida na pesquisa de Milo e, como será mostrado a seguir, rendeu bons resultados na pesquisa aqui apresentada.
...
$$
\mathrm{precisão}: ~\frac{R \cap L}{L},
$$ % XXX: precisão está aparecendo como preciso na fórmula.

e a cobertura é

$$
\mathrm{cobertura}: ~\frac{R \cap L}{R}.
$$
...
\begin{section}{Software-realismo de Modelos de Redes}
...
% XXX Para afirmar isso seria necessário repetir o experimento com redes de Erdos-Renyi
