...
\begin{subsection}{Rascunho}
	...
	% A Figura XXX exemplifica o mecanismo de ligação preferencial.
	...
	% Modelo BA:
	% n = 1.000
	% m = 2,3,4,5,6,7,8,9,10 (justificativa, no apêndice, o número de arestas é de X até Y vezes o número de vértces)
	% variações: não-orientado, orientado l.p com grau total, orientado com l.p. com grau de entrada
	% 20 repetições
	%
	% Modelo ER:
	% n = 1.000
	% m = de 2.000 até 20.000 (redes orientadas) em passos de 100. (justificativa igual à do modelo BA)
