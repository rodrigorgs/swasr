\chapter{Um Modelo de Classificação de Redes}
...
\begin{section}{Definição do Classificador Proposto} \label{cap:clas2}
...
\begin{section}{Indução de um Modelo de Classificação} \label{cap:clas4}
