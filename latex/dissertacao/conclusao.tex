...
\begin{itemize}
	...
	\item fornecimento de evidências empíricas de que os modelos são capazes de gerar redes software-realistas;
...
As cinco primeiras contribuições desta pesquisa foram documentadas no artigo ``Modular Network Models for Class Dependencies in Software'', apresentado no 14º Congresso Europeu sobre Manutenção de Software e Reengenharia (CSMR 2010). 
