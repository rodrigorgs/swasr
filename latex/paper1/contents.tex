...
%design dependencies, in which modifications to one module might XXX
...
%The assignment of developers to implementation components of a system affects
%the amount of communication needed between developers. 
...
%This kind of network is the input for many software clustering
...
through network theory. %Software networks can be studied by network theory.
