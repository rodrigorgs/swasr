...
% TODO: say that we use DIRECTED GRAPHS
...
inter-module dependencies as possible.% (i.e., the modules are weakly couple.).
...
%empirical studies regarding the quality of the decompositions they find.
